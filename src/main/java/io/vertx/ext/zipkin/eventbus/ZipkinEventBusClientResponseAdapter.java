 ...
 * TODO: document
 *
 * TODO: allow Vertx applications to provide custom annotations.
 */
public class ZipkinEventBusClientResponseAdapter implements ClientResponseAdapter {
  private final Message msg;

  public ZipkinEventBusClientResponseAdapter(final Message msg) {
    this.msg = msg;
  }
